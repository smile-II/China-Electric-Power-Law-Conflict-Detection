...
if __name__ == "__main__":
    input_file = r"D:\project\legal\data\raw_datasets\chinese law and regulations\combined_laws_transformed.json"  # 输入文件路径
    output_file = r"D:\project\legal\data\raw_datasets\chinese law and regulations\combined_laws_transformed_split.json"  # 输出文件路径
